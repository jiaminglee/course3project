...
# Part 1 - Merging Training and Test data into a common datasets named subject activity and features
...
# Merge data and stored in completeData
...
# PArt 3 - ADding descriptive activity names
...
# Writing it to file tidy_data.txt
